#Fig 3 with no shielding cost included
#Updated on Sep 2, 2024

rm(list = ls())
library(scales)

para_input<-read.csv(file = "templates/LAAB_PrEP_template_s3_1new.csv")
source("scripts/plot.R")
wtp<-k<-seq(from=0,to=120000,by=1000)
for (i in 1:length(k)) {
  wtp[i]<-sum(LYG*k[i] > COST)/length(LYG)
}
df1<-data.frame(buget=k,prob=wtp,group=rep("High fatigue",length(k)))

para_input<-read.csv(file = "templates/LAAB_PrEP_template_s1_1new.csv")
source("scripts/plot.R")
wtp<-k<-seq(from=0,to=120000,by=1000)
for (i in 1:length(k)) {
  wtp[i]<-sum(LYG*k[i] > COST)/length(LYG)
}
df3<-data.frame(buget=k,prob=wtp,group=rep("Low fatigue-Low replacement",length(k)))

para_input<-read.csv(file = "templates/LAAB_PrEP_template_s2_1new.csv")
source("scripts/plot.R")
wtp<-k<-seq(from=0,to=120000,by=1000)
for (i in 1:length(k)) {
  wtp[i]<-sum(LYG*k[i] > COST)/length(LYG)
}
df4<-data.frame(buget=k,prob=wtp,group=rep("Low fatigue-High replacement",length(k)))
...
df<-read.csv("outputs/LAAB_PrEP_outputs_th2new.csv")
wtp<-k<-seq(from=0,to=120000,by=1000)
for (i in 1:length(k)) {
...
df<-read.csv("outputs/LAAB_PrEP_outputs_th5new.csv")
wtp<-k<-seq(from=0,to=120000,by=1000)
for (i in 1:length(k)) {
  wtp[i]<-sum(df$LYG*k[i] > df$COST)/length(df$LYG)
}
...
df<-read.csv("outputs/LAAB_PrEP_outputs_th10new.csv")
wtp<-k<-seq(from=0,to=120000,by=1000)
for (i in 1:length(k)) {
  wtp[i]<-sum(df$LYG*k[i] > df$COST)/length(df$LYG)
}
...
mop<-read.csv(file = "outputs/LAAB_PrEP_outputsnew.csv") 
...
df<-read.csv("outputs/LAAB_PrEP_output_advancedHIVnew.csv")
wtp<-k<-seq(from=0,to=120000,by=1000)
for (i in 1:length(k)) {
  wtp[i]<-sum(df$LYG*k[i] > df$COST)/length(df$LYG)
}
...
df<-read.csv("outputs/LAAB_PrEP_output_endstagenew.csv")
wtp<-k<-seq(from=0,to=120000,by=1000)
for (i in 1:length(k)) {
  wtp[i]<-sum(df$LYG*k[i] > df$COST)/length(df$LYG)
}
...
df<-read.csv("outputs/LAAB_PrEP_output_haematolognew.csv")
wtp<-k<-seq(from=0,to=120000,by=1000)
for (i in 1:length(k)) {
  wtp[i]<-sum(df$LYG*k[i] > df$COST)/length(df$LYG)
}
...
df<-read.csv("outputs/LAAB_PrEP_output_highdosenew.csv")
wtp<-k<-seq(from=0,to=120000,by=1000)
for (i in 1:length(k)) {
  wtp[i]<-sum(df$LYG*k[i] > df$COST)/length(df$LYG)
}
...
df<-read.csv("outputs/LAAB_PrEP_output_organtransnew.csv")
wtp<-k<-seq(from=0,to=120000,by=1000)
for (i in 1:length(k)) {
  wtp[i]<-sum(df$LYG*k[i] > df$COST)/length(df$LYG)
}
...
df<-read.csv("outputs/LAAB_PrEP_output_primaryimmunew.csv")
wtp<-k<-seq(from=0,to=120000,by=1000)
for (i in 1:length(k)) {
  wtp[i]<-sum(df$LYG*k[i] > df$COST)/length(df$LYG)
}
...
df<-read.csv("outputs/LAAB_PrEP_output_secondaryimmonew.csv")
wtp<-k<-seq(from=0,to=120000,by=1000)
for (i in 1:length(k)) {
  wtp[i]<-sum(df$LYG*k[i] > df$COST)/length(df$LYG)
}
...
df<-read.csv("outputs/LAAB_PrEP_output_solidtumnew.csv")
wtp<-k<-seq(from=0,to=120000,by=1000)
for (i in 1:length(k)) {
  wtp[i]<-sum(df$LYG*k[i] > df$COST)/length(df$LYG)
}
...
ggarrange(p1,p2,p3,p4,ncol = 2, nrow = 2,
          align="v")
# ggsave("nc.jpg", ggarrange(p1,p2,p3,p4,ncol = 2, nrow = 2, align = "v"), height = 9, width = 11)
