...
# To plot important parameters under three time horizon in Fig 2
########################################################################
rm(list = ls())
# load the library
library(forcats)
...
mop<-read.csv(".../LAAB_PrEP_outputs_th2.csv")
...
mop<-read.csv(".../LAAB_PrEP_outputs_th5.csv")
# remove redundant parameters
aa<-subset(mop, select = -c(X,LNH, LNU, LNV, thetaH,deltaC,lambda_obs))
...
mop<-read.csv(".../LAAB_PrEP_outputs_th10.csv.csv")
# remove redundant parameters
aa<-subset(mop, select = -c(X,LNH, LNU, LNV, thetaH,deltaC,lambda_obs))
