...
###   Script for generating scenario low fatigue and high replacement  ###
...
para_input<-read.csv(file = "LAAB_PrEP_template_s2.csv")
...
write.csv(x = data_output,file = "LAAB_PrEP_outputs_s2_1.csv")
...
p2<-ggplot(data=data_ggplot2,aes(x=buget,y=prob))+
  ...
  geom_vline(xintercept = 20000, color = "blue", size=0.5)+
