...
para_input<-read.csv(file = "C:/Users/sc7685/OneDrive - Princeton University/projects/5_LAAB/LAAB_hop/UploadGit/templates/LAAB_PrEP_template_th5.csv")
...
write.csv(x = data_output,file = "LAAB_PrEP_outputs_th5new.csv")
