...
### An example of generating RDS files for ICER min T=2 ###
###########################################################
rm(list = ls())        
set.seed(100)          
...
para_input<-read.csv(file = "LAAB_PrEP_template.csv")
...
saveRDS(data,"dataICER_min2_nocosta.rds")
